<?php
		...
		/** 
		  * API file to find create/ update user record in crm.
		  * Date        : Mar-17-2017
		...
		*/
	    ...
	    if( $connection ){
			...
			if ($row) {
				...
				$final_array['user_exists'] = "yes";

				$existing_user_status       = $row['status'];

				$final_array['existing_user_status'] = $existing_user_status;
        ...
        $final_array['user_id'] = $userSimplecrmId;

		$outputArrr = array();
		$outputArrr['Android'] = $final_array;
