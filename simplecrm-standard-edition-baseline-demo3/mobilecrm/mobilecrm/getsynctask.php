...
$sql2 = "SELECT IFNULL( ta.id, '' ) AS id, IFNULL( ta.name, '' ) AS name,
        IFNULL( ta.created_by, '' ) AS created_by,
         ...
         IFNULL( tac.date_modified_mobile_c, '' ) AS date_modified_mobile_c,
         IFNULL( tac.mobile_id_c, '' ) AS mobile_id_c,
         IFNULL( tac.calender_id_c, '' ) AS calender_id_c,
         IFNULL( tac.task_notification_status_c, '' ) AS task_notification_status_c,
         IFNULL( tac.reminder_c, '' ) AS reminder_c,  IFNULL( tac.record_source_c, '' ) AS record_source_c,
         IFNULL( tac.mobile_offline_unique_id_c, '' ) AS mobile_offline_unique_id,
...
WHERE ta.assigned_user_id = '$assigned_user_id'   AND tac.deleted_from_mobileapp_c = '0'  AND ta.deleted = '0' AND ta.date_modified >=  '$date_modified_sugar_format_sync' order by ta.date_modified DESC";
